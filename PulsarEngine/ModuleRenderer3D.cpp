...
ModuleRenderer3D::ModuleRenderer3D(Application* app, bool start_enabled) : Module(app,"Render",start_enabled)
{
}
...
void ModuleRenderer3D::RenderBox(float3 corners[8])
{
...
void ModuleRenderer3D::OnResize(int width, int height, int offsetX, int offsetY)
{
	...
	glLoadMatrixf(App->camera->GetGLProjectionMatrix());
