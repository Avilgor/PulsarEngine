...
void PhysVehicle3D::Render()
{
	...
	CubePrimitive FrontChassis(info.front_chassis_size.x, info.front_chassis_size.y, info.front_chassis_size.z);
	...
	CubePrimitive RearChassis(info.rear_chassis_size.x, info.rear_chassis_size.y, info.rear_chassis_size.z);
